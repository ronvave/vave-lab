...
(function () {
  ...
  var V1_URL   = 'data/solomon-scholar-insights.json';
  var V2_URL   = 'data/solomon-scholar-insights-master.json';
  var V2_ENC   = 'data/solomon-scholar-insights-master.json.enc';
