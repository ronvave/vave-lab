/**
 * Demo-mode gate for the iTaukei Research Database (dashboard).
 *
 ...
 * The .enc data files stay encrypted with the same passcode-derived key
 * as before (Arachnid1!), but that passcode is now baked into this file
...
(function () {
  ...
  var REVOKE_PATH = 'data/revoked-demos.json';
  ...
  var BAKED_PASSCODE = atob('QXJhY2huaWQxIQ==');
  ...
  // list at any time.
  var DEMO_SIGN_KEY_B64 = 'VmF2ZUxhYi1EZW1vLVNpZ25pbmctS2V5LTIwMjYtdjEtVmF2ZQ==';
  ...
  function buildShellHtml(reason) {
    ...
    return ''
      ...
      +     '</div>'
      +     '<h1 class="demo-gate-shell__title">iTaukei Research Database</h1>'
