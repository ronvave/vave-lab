...
(function () {
  ...
  function buildDirectIntro(){
    const box=document.createElement('section');box.className='scholar-direct-intro';box.innerHTML=`
      ...
      <p><strong>About this database.</strong> The iTaukei Scholarly Research Database is a curated public resource developed to highlight and elevate the scholarship and contributions of iTaukei postgraduates and researchers in Fiji and around the world. It is part of a larger Pacific scholarly database project being replicated across Pacific Island countries. <strong>The database and dashboard are still being developed and have not yet been publicly launched.</strong></p>
