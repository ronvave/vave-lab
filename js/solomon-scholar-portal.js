...
async function renderShared(state,renderCard,renderItem){
 ...
 intro.innerHTML=`<div class="direct-review-badge">SCHOLAR PROFILE REVIEW</div>
 <p><strong>About this database.</strong> The Solomon Islands Scholarly Research Database highlights Indigenous Solomon Islands scholarship as part of the Pacific scholar database initiative led by <a href="https://ronvave.github.io/vave-lab/" target="_blank" rel="noopener">Dr. Ron Vave</a>.</p>
 <p><strong>Help improve this profile.</strong> Use Update info below to suggest corrections, provide a headshot, CV or thesis, or submit publications. Scholars, family, friends, students and colleagues may submit on a scholar’s behalf.</p>
 <p><strong>Updates require review.</strong> Approved changes appear after a successful public data refresh. Submission is not approval.</p>
 <p><strong>Maternal information is optional and private.</strong> Maternal details and CVs are for internal review and are not displayed publicly.</p>`;
