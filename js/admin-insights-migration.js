/**
 * admin-insights-migration.js
 *
 * Client-side one-off migration for the V1 name-keyed research-insights file
 * (data/scholar-insights.json.enc) to a Scholar-ID-keyed file
 * (data/scholar-insights-master.json.enc) consumed by the V2 dashboard.
 *
...
(function () {
  ...
  var V1_URL   = 'data/scholar-insights.json';
  var V2_URL   = 'data/scholar-insights-master.json';
  var V2_ENC   = 'data/scholar-insights-master.json.enc';
