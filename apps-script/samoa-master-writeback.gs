 ...
 * system to the iTaukei / Tongan / Solomon master-writeback.gs — own spreadsheet ID, own
 * SHARED_SECRET, own deployment. It must never read from or write to the
 * iTaukei, Tongan, or Solomon Islands spreadsheet.
 *
 ...
 *        SHARED_SECRET      = 3165379b362f4447bc228abdd75d6668f7b4a3475d57a6298a3593ac3d431645  (pre-generated for Samoa system; do not reuse the iTaukei, Tongan, or Solomon secret)
 *        WRITE_ENABLED      = true
...
// ────────────────────────────────────────────────────────────────────────────
// ⚠ SAMOA ALLOWLIST — REGENERATE FROM THE SAMOA MASTER SHEET BEFORE ENABLING
// The field names below are inherited from the Tongan sister writeback and
// DO NOT MATCH the Samoa Master Sheet's actual column headers. Before setting
// WRITE_ENABLED=true, edit the ALLOWLIST below so each entry matches an exact
// column header in the Samoa Scholars / Graduate Degrees / Positions /
// Publications / Authorship / Research Geography tabs. See:
//   • docs/SAMOA-APPS-SCRIPT-DEPLOY.md
//   • Samoa Master Sheet — row 4 of each tab
// ────────────────────────────────────────────────────────────────────────────

// ------------------------- CONFIG -----------------------------------------
var SPREADSHEET_ID_HINT = 'SET_ME_TO_SAMOA_MASTER_SHEET_ID'; // Samoa Scholar Database — NEVER the iTaukei (1nJv...), Tongan (1lh6...), or Solomon sheet
  ...
  worksheets: {
    'Scholars': {
      ...
      fields: {
        ...
        //   Scholar Name, Paternal Statistical Region is derived by Lookups so read-only in UI,
        //   Highest Completed Degree, Degree Episodes, International Degree Episodes,
        //   Samoa Degree Episodes, Funding Episodes, Awards Count, Gold Medals / Prizes Count,
    ...
    'Graduate Degrees': {
      ...
      fields: {
        ...
        'Country':                     { type: 'string', maxLen: 80 },
        'International from Samoa?':   { type: 'enum',   enum: ['Yes','No','Unknown',''] },
